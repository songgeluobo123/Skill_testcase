...
```
testcase-generator/
├── SKILL.md                 # Skill main instructions (Chinese)
├── README.md                # Chinese documentation
├── README.en.md             # English documentation
├── LICENSE                  # MIT
├── references/              # Methodology & specs (12 files)
│   ├── workflow.md          # 6-step workflow
│   ├── case_design.md       # 10 case-design principles + naming/format specs
│   ├── output_format.md     # 10-column Excel template spec
│   ├── test_methods.md      # 6 black-box methods explained
│   ├── data_rules.md        # Test-data validation rules + priority model
│   ├── function_points.md   # Function-point decomposition
│   ├── testpoint_checklist.md # Test-point 5-dimension checklist
│   ├── quality_standards.md # 4 quality standards
│   ├── quality_prescreen.md # Quality prescreen 6 gates & thresholds
│   ├── memory_mechanism.md  # Memory mechanism
│   ├── multimodal.md        # Multimodal UI reading
│   └── xmind_output.md      # XMind output format
