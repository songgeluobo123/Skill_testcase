...
| 级别 | 范围 | 执行要求 | 占比建议 |
|---|---|---|---|
| **P0** 🔴 | 核心链路 / 冒烟 / 安全合规 / 数据正确性（一票否决） | 每次构建必跑，100% 通过方可发布 | 10%~15% |
| **P1** 🟠 | 重要功能 / 高频场景 / 主流兼容性 | 每轮主测试（SIT / 回归主集）必覆盖 | 25%~35% |
| **P2** 🔵 | 一般功能 / 次要场景 / 低频兼容 | 常规迭代覆盖，回归可选 | 35%~45% |
| **P3** ⚪ | 边缘场景 / 极端边界 / 探索性 | 全量或按需覆盖，不计入发布门禁 | 10%~20% |
